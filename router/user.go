...
func (r *Router) LoginHandler(ctx echo.Context) error {
	...
	userMap := map[string]interface{}{
		...
		"lastname":     "Doe",
		"nutritionist": true,                                                                                                                               // Placeholder, replace with actual last name
	...
	// Ensure the "nutritionist" field is not null
	if _, ok := userMap["nutritionist"]; !ok {
		userMap["nutritionist"] = false
	}
